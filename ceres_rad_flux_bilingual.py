...
fpath_ceres = "CERES_EBAF-TOA_Ed4.2.1_Subset_200003-202409.nc"
...
with open("gistemp_2024-11_reduced.csv") as gistemp_p:
...
ax2b = axs[2].twinx()
# Adding Gistemp temperature anomaly
ax2b.plot(gistemp_12months_smoothed.time, gistemp_12months_smoothed,
            color="red", linewidth=4)
ax2b.set_ylim(0.3, 1.4) 
axs[2].set_ylabel('ToA absorbed SW', color='black', fontsize = 10)
...
print (gistemp_monthly_temperatures)
...
print (gistemp_12months_smoothed)

print (type(absorbed_weighted_mean_smoothed))
print (type(gistemp_12months_smoothed))
...
ax.text(datetime(2018, 9, 1), 240.7, '''Data: CERES (NASA)''',
            style='italic',
            bbox={'facecolor': 'grey', 'alpha': 0.5, 'pad': 10}, fontsize=14)
ax.text(datetime(2016, 1, 1), 99.5, 'Data NASA/NOAA, author: M. Šálek', style='italic',
        bbox={'facecolor': 'grey', 'alpha': 0.1, 'pad': 10}, fontsize=8)

ax2 = ax.twinx()
# Adding Gistemp temperature anomaly
ax2.plot(toa_net_weighted_mean.time, gistemp_12months_smoothed,
            color="red", linewidth=4)
ax2.set_ylim(0.3, 1.4) 
ax.set_ylabel('ToA absorbed SW radiation', color='blue', fontsize = 16)
ax2.set_ylabel('Gistemp temperature anomaly', color='red', fontsize = 16)
